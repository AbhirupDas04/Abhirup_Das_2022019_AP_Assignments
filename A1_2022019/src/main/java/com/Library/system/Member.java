...
public class Member {
    ...
    protected void issueBook(){
        ...
        if(this.penalty_money > 0){
            System.out.println("---------------------------------");
            System.out.println("Please pay the penalty money " + this.penalty_money + " Rs. that you owe after which you can issue further books!");
            return;
        }
    ...
    protected void returnBook(){
        ...
        while(true){
            try{
                ...
                Main_Input = new Scanner(System.in);
                Main_Input.useDelimiter("\n");
                id = Integer.parseInt(Main_Input.nextLine());
                System.out.println("---------------------------------");
            }
            catch(NumberFormatException e){
                System.out.println("---------------------------------");
